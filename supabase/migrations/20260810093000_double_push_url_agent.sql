-- Fix: the Onside Double push deep-linked to /double, but the double lives on the agent feed now
-- (no separate /double page). Point the push back at /agent. Body is otherwise identical to
-- 20260810090000 (the wait-for-all-agents gate is preserved).
